	...
	<div class="content-wrapper py-3">
		<div>
			<div class="col-sm-12 text-center">
				...
				<div class="col-sm-12">
					<h3>
						팁과 노하우 - <span style="color: gray; font-size: 0.8em;">개발하면서 얻은 팁이나 노하우를 공유할 수 있는 게시판입니다.</span>
					</h3>
				</div>
				<div class="col-sm-12">
					<!-- 조건문 처리공간 
								...
								<tr>
									<td colspan="5">
										<select name="" id="" class="form-control" style="width:150px; height:20px;">
											<option value="">초보자 팁</option>
											<option value="">설치법</option>
											<option value="">TOOL 관련 팁</option>
										</select>
									</td>
								</tr>
								<tr>
